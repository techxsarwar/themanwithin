...
2. **Connect to Render using Blueprint**
   ...
   - Render will automatically read the `render.yaml` file and set up a Web Service with the correct `Start Command` (`uvicorn main:app --host 0.0.0.0 --port 10000`) and Environment (`Python`).
